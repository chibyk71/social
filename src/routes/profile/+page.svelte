<script lang="ts">
	...
	import { GearSolid } from 'svelte-awesome-icons';
				...
				<div class="tab-content" id="myTabContent3">
					<div class="tab-pane fade show active" id="home-tab-pane3" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
						<div class="dz-lightgallery style-2" id="lightgallery">
							...
							<a class="gallery-box" href="images/post/pic7.png">
								<img src="images/post/pic7.png" alt="image">
							</a>
							<a class="gallery-box" href="images/post/pic8.png">
								<img src="images/post/pic8.png" alt="image">
							</a>
						</div>
					</div>
