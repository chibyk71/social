...
<!-- Header End -->
				...
				<div class="left-content">
					...
					<div class="ml-3">
						...
						<ul class="meta-list">
							...
							<li class="mr-2">
								<a href={void(0)}>
									<PlusSolid class="!w-2 !h-3.5 mr-1" />
									Album
									<AngleDownSolid class="w-4 h-4 ml-2"/>
								</a>
							</li>
    ...
    <footer class="footer border-0 fixed bg-transparent">
        <div class="container pt-0">
				<ul class="element-list">
					...
					<li>
						<a href="/live">
							<VideoSolid class="w-4 h-4 mr-2 fill-primary"/>Live Video
						</a>
					</li>
					<li>
						<a href="new-post.html">
							<CameraSolid class="w-4 h-4 mr-2 fill-primary"/>Camera
						</a>
					</li>
				</ul>
        </div>
	...
	<Canvas id="privacy">
		...
		<div class="small overflow-y-auto no-scroll-bar" slot="body">
			<h6 class="title">Who can see your post?</h6>
			<ul class="list-style-1 list-none">
				<li>
			...
			<h6 class="title">Use of our Website</h6>
			<ul class="element-list style-2 list-none">
				<li>
					<a href="javascript:void(0);">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<mask id="mask0_33437_4524" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="2" y="13" width="16" height="9">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M2 13.957H17.1838V21.0566H2V13.957Z" fill="white"></path>
							</mask>
							...
							<path fill-rule="evenodd" clip-rule="evenodd" d="M17.8452 13.4834H21.979V18.4609H17.8452V13.4834Z" fill="white"></path>
							</mask>
