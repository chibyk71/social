...
<TopBar title="chat">
    <svelte:fragment slot="right">
        <a href="notification.html" class="bell-icon">
			...
			<div class="container bottom-content">
				<form>
					<div class="input-group flex w-full">
						<input type="text" class="form-control flex-1" placeholder="Search..">
				...
				<ul class="dz-list message-list">
					<li>
						<a href="messages-detail.html">
							<div class="media media-50">
								<img class="rounded" src="images/message/pic1.jpg" alt="image">
							</div>
							<div class="media-content">
								<div>
									<h6 class="name">Lucas Mokmana</h6>
									<p class="my-1">
					...
					<li>
						<a href="messages-detail.html">
							<div class="media media-50">
								<img class="rounded" src="images/message/pic2.jpg" alt="image">
							</div>
							<div class="media-content">
								<div>
									<h6 class="name">Emilia Green</h6>
									<p class="my-1">
					...
					<li>
						<a href="messages-detail.html">
							<div class="media media-50">
								<img class="rounded" src="images/message/pic3.jpg" alt="image">
							</div>
							<div class="media-content">
								<div>
									<h6 class="name">Richard lee</h6>
									<p class="my-1">
										Cmon dude! make it fast, let’s go
									</p>
								</div>
								<div class="left-content">
									<span class="time">2m ago</span>
					...
					<li>
						<a href="messages-detail.html">
							<div class="media media-50">
								<img class="rounded" src="images/message/pic4.jpg" alt="image">
							</div>
							<div class="media-content">
								<div>
									<h6 class="name">Hendri Lee</h6>
									<p class="my-1">
										Did you tell him about your new car?
									</p>
								</div>
								<div class="left-content">
									<span class="time">2m ago</span>
					...
					<li>
						<a href="messages-detail.html">
							<div class="media media-50">
								<img class="rounded" src="images/message/pic5.jpg" alt="image">
							</div>
							<div class="media-content">
								<div>
									<h6 class="name">Mogan Fox</h6>
									<p class="my-1">
										Let's go!
									</p>
								</div>
