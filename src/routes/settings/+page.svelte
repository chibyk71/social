<script lang="ts">
	...
	import { LanguageSolid } from 'svelte-awesome-icons';
    import type { PageData } from './$types';
	import Toggle from '$lib/comp/toggle.svelte';
 ...
 <div class="page-content">
        <div class="container">
            <div class="dz-list">
				<ul>
					<li>
						<a href={void(0)} class="item-content item-link filter m-0 filter m-0">
							<div class="dz-icon icon-sm">
								<svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 24 24" ><path d="M12 23a2 2 0 0 0 2-2h-4a2 2 0 0 0 2 2zm8.924-4.617a1 1 0 0 0-.217-1.09L19 15.586V10a7 7 0 0 0-6-6.92V2a1 1 0 0 0-2 0v1.08A7 7 0 0 0 5 10v5.586l-1.707 1.707A1 1 0 0 0 4 19h16a1 1 0 0 0 .924-.617zM6.414 17l.293-.293A1 1 0 0 0 7 16v-6a5 5 0 0 1 10 0v6a1 1 0 0 0 .293.707l.293.293z"/></svg>
							</div>
							<div class="dz-inner">
					...
					<li>
						<a href="/settings/security/" class="item-content item-link filter m-0">
							<div class="dz-icon icon-sm">
								<svg height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m459.669 82.906-196-81.377c-4.91-2.038-10.429-2.039-15.338 0l-196 81.377c-7.465 3.1-12.331 10.388-12.331 18.471v98.925c0 136.213 82.329 258.74 208.442 310.215 4.844 1.977 10.271 1.977 15.116 0 126.111-51.474 208.442-174.001 208.442-310.215v-98.925c0-8.083-4.865-15.371-12.331-18.471zm-27.669 117.396c0 115.795-68 222.392-176 269.974-105.114-46.311-176-151.041-176-269.974v-85.573l176-73.074 176 73.074zm-198.106 67.414 85.964-85.963c7.81-7.81 20.473-7.811 28.284 0s7.81 20.474-.001 28.284l-100.105 100.105c-7.812 7.812-20.475 7.809-28.284 0l-55.894-55.894c-7.811-7.811-7.811-20.474 0-28.284s20.474-7.811 28.284 0z"/></svg>
							</div>
							<div class="dz-inner">
					...
					<li>
						<a href={void(0)} on:click={()=>canvas.open("language")} class="item-content item-link filter m-0">
							<div class="dz-icon icon-sm">
								<LanguageSolid />
							</div>
							<div class="dz-inner">
					...
					<li>
						<a href="about.html" class="item-content item-link filter m-0">
							<div class="dz-icon icon-sm">
					...
					<li>
						<a href="/terms" class="item-content item-link filter m-0">
							<div class="dz-icon icon-sm">
								<svg height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m276 374c0 11.046-8.954 20-20 20h-118c-11.046 0-20-8.954-20-20s8.954-20 20-20h118c11.046 0 20 8.954 20 20zm236-253.85v234.183c0 30.708-11.958 59.576-33.672 81.289l-42.706 42.707c-21.713 21.713-50.581 33.671-81.289 33.671h-234.183c-66.411 0-120.15-53.745-120.15-120.15v-271.7c0-66.411 53.745-120.15 120.15-120.15h271.7c66.411 0 120.15 53.745 120.15 120.15zm-42.683 254.183h-54.984c-22.056 0-40 17.944-40 40v54.984c12.362-3.4 23.692-9.961 33.004-19.272l42.707-42.708c9.312-9.312 15.873-20.642 19.273-33.004zm2.683-254.183c0-44.301-35.851-80.15-80.15-80.15h-271.7c-44.301 0-80.15 35.851-80.15 80.15v271.7c0 44.301 35.851 80.15 80.15 80.15h214.183v-57.667c0-44.112 35.888-80 80-80h57.667zm-98 115.85h-236c-11.046 0-20 8.954-20 20s8.954 20 20 20h236c11.046 0 20-8.954 20-20s-8.954-20-20-20zm0-118h-236c-11.046 0-20 8.954-20 20s8.954 20 20 20h236c11.046 0 20-8.954 20-20s-8.954-20-20-20z"/></svg>
							</div>
							<div class="dz-inner">
					...
					<li>
						<a href="/login" class="item-content item-link filter m-0">
							<div class="dz-icon icon-sm">
	...
	<Canvas drag={false} id="language" position="top">
		...
		<svelte:fragment slot="body">
			...
			<a href={void(0)} class="btn btn-primary btn-block mb-2 text-center">Save</a>
		</svelte:fragment>
	</Canvas>